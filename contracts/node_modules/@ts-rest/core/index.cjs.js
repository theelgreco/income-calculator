 ...
 * @deprecated supports zod 3, does not support other validators, you can bring your own schema, from next major version this will be removed
 */
const RequestValidationErrorSchemaWithoutMessage = z.object({
 ...
 * @deprecated supports zod 3, does not support other validators, you can bring your own schema, from next major version this will be removed
 */
const RequestValidationErrorSchemaForNest = z.object({
...
const validateMultiSchemaObject = (data, schemaObject) => {
    ...
    if (vendorSet.size > 1 && vendorSet.has(VENDOR_LEGACY_ZOD)) {
        throw new Error('Cannot mix zod legacy and standard schema libraries, please use zod >= 3.24.0 or any other standard schema library');
    }
...
const combineStandardSchemas = (a, b) => {
    ...
    if (isJustOneZodLegacy) {
        throw new Error('Cannot combine a zod < 3.24.0 schema with a standard schema, please use zod >= 3.24.0 or any other standard schema library');
    }
    /**
 ...
 */
const areAllSchemasLegacyZod = (schemas) => {
    return schemas
        .filter(Boolean)
        .every((schema) => (schema === null || schema === void 0 ? void 0 : schema['~standard'].vendor) === VENDOR_LEGACY_ZOD);
};
...
exports.RequestValidationErrorSchemaForNest = RequestValidationErrorSchemaForNest;
exports.RequestValidationErrorSchemaWithoutMessage = RequestValidationErrorSchemaWithoutMessage;
...
exports.areAllSchemasLegacyZod = areAllSchemasLegacyZod;
