export default {
    root: ({ props, context, parent, instance }) => ({
        class: [
            ...
            // Primary Button
            {
                "text-white bg-gray-800": !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
            },
            // Primary Text Button
            ...
            // Secondary Button
            {
                ...
                "bg-white-100 dark:bg-white-700": props.severity === "secondary" && !props.text && !props.outlined && !props.plain,
            ...
            {
                "hover:bg-gray-100 border border-gray-300 hover:border-gray-500":
            ...
            { "hover:bg-white-300/10": props.plain && (props.text || props.outlined) },
            ...
            // Secondary
            {
                "hover:bg-white-200 dark:hover:bg-white-600 hover:border-surface-200 dark:hover:border-surface-600":
                    props.severity === "secondary" && !props.text && !props.outlined && !props.plain,
            },
            { "focus:ring-surface-500 dark:focus:ring-surface-400": props.severity === "secondary" },
            // Text & Outlined Button
            { "hover:bg-white-300/10": (props.text || props.outlined) && props.severity === "secondary" && !props.plain },
            ...
            // Contrast
            {
                "hover:bg-white-800 dark:hover:bg-white-100 hover:border-surface-800 dark:hover:border-surface-100":
                    props.severity === "contrast" && !props.text && !props.outlined && !props.plain,
            },
            { "focus:ring-surface-500 dark:focus:ring-surface-400": props.severity === "contrast" },
            // Text & Outlined Button
            {
                "hover:bg-white-900/10 dark:hover:bg-[rgba(255,255,255,0.03)]":
