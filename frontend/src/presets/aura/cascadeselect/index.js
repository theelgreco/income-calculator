    ...
    option: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                ...
                "text-surface-500 dark:text-white/70 bg-white-200 dark:bg-white-600/90": context.focused && !context.active,
            ...
            // States
            {
                "hover:bg-white-100 dark:hover:bg-[rgba(255,255,255,0.03)]": !context.active,
