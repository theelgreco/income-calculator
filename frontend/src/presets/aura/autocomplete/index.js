    ...
    option: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                ...
                "bg-white-200 dark:bg-white-600/60": context.focused && !context.selected,
                "text-surface-700 dark:text-white/80": context.focused && !context.selected,
                "bg-highlight": context.selected,
            },

            //States
            { "hover:bg-white-100 dark:hover:bg-[rgba(255,255,255,0.03)]": !context.focused && !context.selected },
