    ...
    box: ({ props, context }) => ({
        class: [
            ...
            // Colors
            {
                ...
                "bg-white dark:bg-white-950": !context.checked && !props.invalid && !props.disabled,
            ...
            // States
            {
                ...
                "peer-focus-visible:z-10 peer-focus-visible:outline-hidden peer-focus-visible:outline-offset-0 peer-focus-visible:ring-1 peer-focus-visible:ring-primary-500 dark:peer-focus-visible:ring-primary-400":
                    !props.disabled,
                "bg-white-200 dark:bg-white-700 select-none pointer-events-none cursor-default": props.disabled,
            },
