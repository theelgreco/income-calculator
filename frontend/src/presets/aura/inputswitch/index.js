export default {
    ...
    slider: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                "bg-white-300 dark:bg-white-800": !(props.modelValue == props.trueValue) && !props.invalid,
                "bg-primary": props.modelValue == props.trueValue && !props.invalid,
                "before:dark:bg-white-950": props.modelValue == props.trueValue,
            },
            ...
            // States
            {
                "peer-hover:bg-white-400 dark:peer-hover:bg-white-700":
