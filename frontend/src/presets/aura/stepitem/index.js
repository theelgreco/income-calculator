export default {
    root: ({ state }) => ({
        class: [
            'flex flex-col flex-[initial] has-data-[pc-name=steppanels]:px-2 has-data-[pc-name=steppanels]:pt-3.5 has-data-[pc-name=steppanels]:pb-4.5',
